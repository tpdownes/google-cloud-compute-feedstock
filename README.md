...
pixi add google-cloud-compute
# for installing globally
pixi global install google-cloud-compute
```
...
It is possible to list all of the versions of `google-cloud-compute` available on your platform:
...
```
pixi search google-cloud-compute --channel conda-forge
```
